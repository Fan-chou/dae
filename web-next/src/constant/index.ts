...
export const isConnectionGroupableKey = (
  value: unknown,
): value is ConnectionGroupableKey =>
...
export const naturalSortDirection = (sortType: SORT_TYPE) =>
  SORT_TYPE_VALUE_KIND[sortType] === SORT_VALUE_KIND.TEXT
    ? SORT_DIRECTION.ASC
    : SORT_DIRECTION.DESC

export const SORT_DIRECTION_LABEL_KEY: Record<
  SORT_VALUE_KIND,
  Record<SORT_DIRECTION, string>
> = {
...
export const SORT_TYPE_GROUPS: {
  labelKey: string
  types: readonly SORT_TYPE[]
}[] = [
  {
    labelKey: 'basic',
    types: [
  ...
  },
  {
    labelKey: 'traffic',
    types: [
      SORT_TYPE.DOWNLOAD_SPEED,
      SORT_TYPE.UPLOAD_SPEED,
      SORT_TYPE.DOWNLOAD,
      SORT_TYPE.UPLOAD,
    ],
  },
...
export const MIHOMO_CHANNEL: Record<
  MIHOMO,
  { url: string; check_update_url: string }
> = {
  [MIHOMO.Meta]: {
