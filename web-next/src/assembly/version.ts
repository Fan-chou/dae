...
const detectCore = (_versionString: string): Core => Core.Fdae
...
export const coreBrand = computed(() => {
  switch (core.value) {
    case Core.Fdae:
      return {
        logo: new URL('../assets/images/fdae.svg', import.meta.url).href,
        url: 'https://github.com/Fan-chou/dae',
      }
    case Core.Honk:
