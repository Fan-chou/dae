  ...
  >
    <div class="flex flex-col gap-4">
      ...
      <div class="flex flex-wrap gap-2">
        <button type="button" class="btn btn-sm" @click="applyShowAllPreset">
          {{ $t('showAllPreset') }}
        </button>
        <button type="button" class="btn btn-sm" @click="applyMinimalPreset">
          {{ $t('minimalPreset') }}
        </button>
      </div>
      ...
      <div class="flex flex-col gap-3">
        ...
        >
          <summary
            class="flex min-h-12 cursor-pointer list-none items-center gap-2 px-3"
          >
            <input
              type="checkbox"
