  ...
  <template v-if="hasVisibleApplicationItems">
    ...
    <div class="settings-grid">
      ...
      <SettingItem :setting-key="k.actions">
        <div class="setting-item-label">导入 / 导出面板偏好</div>
      ...
      <SettingItem :setting-key="k.autoUpgradeDashboard">
        ...
        <input v-model="autoUpgradeDashboard" class="toggle" type="checkbox" />
      </SettingItem>
    </div>
  </template>
  ...
  <template v-if="hasVisibleNetworkItems">
    ...
    <div class="settings-grid">
      <SettingItem :setting-key="k.autoDisconnectIdleUDP">
        ...
        <input v-model="autoDisconnectIdleUDP" type="checkbox" class="toggle" />
      </SettingItem>
      <SettingItem
  ...
  <template v-if="hasVisibleInteractionItems">
    ...
    <div class="settings-grid">
      ...
      >
        ...
        <input v-model="scrollAnimationEffect" type="checkbox" class="toggle" />
      </SettingItem>
      <SettingItem :setting-key="k.swipeInPages" :when="isMiddleScreen">
        <div class="setting-item-label">{{ $t('swipeInPages') }}</div>
        <input v-model="swipeInPages" type="checkbox" class="toggle" />
      </SettingItem>
      <SettingItem
      ...
      >
        ...
        <input v-model="swipeInTabs" type="checkbox" class="toggle" />
      </SettingItem>
      <SettingItem :setting-key="k.disablePullToRefresh" :when="isMiddleScreen">
        <div class="setting-item-label">
        ...
        <input v-model="disablePullToRefresh" type="checkbox" class="toggle" />
      </SettingItem>
      ...
      >
        ...
        <input v-model="displayAllFeatures" type="checkbox" class="toggle" />
      </SettingItem>
    </div>
  </template>
</template>
...
const isVisibleAutoDisconnectIdleUDP = useIsSettingVisible(
  k.autoDisconnectIdleUDP,
)
const isVisibleAutoDisconnectIdleUDPTime = useIsSettingVisible(
  k.autoDisconnectIdleUDPTime,
)
const isVisibleIPInfoAPI = useIsSettingVisible(k.IPInfoAPI)
const isVisibleGeoipCountryDatabaseURL = useIsSettingVisible(
  k.geoipCountryDatabaseURL,
)
const isVisibleGeoipASNDatabaseURL = useIsSettingVisible(k.geoipASNDatabaseURL)
const isVisibleScrollAnimationEffect = useIsSettingVisible(
  k.scrollAnimationEffect,
)
...
const isVisibleDisablePullToRefresh = useIsSettingVisible(
  k.disablePullToRefresh,
)
