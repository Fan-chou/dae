  ...
  <div class="flex flex-col items-center gap-1 py-2">
    <div class="flex w-full flex-col items-center gap-1">
      <template v-for="(item, index) in statItems" :key="item.key">
        <div v-if="index > 0" class="bg-base-content/8 my-1 h-px w-6" />
...
const statItems = computed(() => {
  return [
    ...
    },
    {
      ...
      secondaryValue: prettyBytesHelper(downloadTotal.value, {
    ...
    },
    {
      ...
      secondaryValue: prettyBytesHelper(uploadTotal.value, {
        maximumFractionDigits: 1,
      }),
    },
    {
      key: 'memory',
      icon: CpuChipIcon,
      value: prettyBytesHelper(memory.value, {
        binary: true,
        maximumFractionDigits: 1,
      }),
    },
