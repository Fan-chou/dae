...
const zh: LANG_MESSAGE = {
  ...
  settingsMenuBackend: 'fdae 服务',
  settingsMenuProxies: '代理',
  settingsMenuConnections: '连接',
  settingsMenuOverview: '概览',
  settingsDescriptionGeneral: '主题、语言与交互偏好，仅保存在当前浏览器',
  settingsDescriptionOverview: '统计卡片与侧栏显示',
  settingsDescriptionBackend: '连接管理、配置编辑与热重载',
  settingsDescriptionProxies: '代理组布局、延迟颜色与图标；选路策略在配置中修改',
  settingsDescriptionConnections: '表格、卡片与设备标签',
  ...
  back: '返回',
  clear: '清除',
  settingsSectionApplication: '语言与偏好管理',
  ...
  settingsSectionCoreOperations: '配置与重载',
