...
// are loaded in a separate, fault-tolerant pass (see loadOffloadBpfObjects).
...
func assignDataplaneToBpf(bpf *bpfObjects, dp *bpfDataplane) {
	...
	bpf.FakeipLpmMap = dp.FakeipLpmMap
	bpf.MacAssocMap = dp.MacAssocMap
	bpf.IpMacAssocMap = dp.IpMacAssocMap
	bpf.MacAssocScratchMap = dp.MacAssocScratchMap
