...
func replayPhase0TCPTLSCorpusFixture(t *testing.T, fixture phase0TCPTLSCorpusFixture) {
	...
	if binding := newTcpFlowBinding(cp.PolicyEpoch(), result, [6]uint8{}); binding.Route.Outbound != fixture.expectedOutbound || binding.Route.Mark != fixture.expectedMark || binding.Route.Must != fixture.expectedMust || binding.Egress.Target != fixture.expectedTarget {
